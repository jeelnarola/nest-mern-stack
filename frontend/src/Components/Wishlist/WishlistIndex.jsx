    ...
    return (
        <div className="container mx-auto p-6">
            ...
            <h2 className="text-3xl font-bold mb-1">
                Your <span className="text-green-600 bg-green-100 px-2">Wishlist</span>
            </h2>
            ...
            {/* Table */}
            <div className="">
                <table className="w-full border-1 border-gray-200 rounded-xl">
                            ...
                            <tr key={item.id} className="border-t border-gray-200">
                                ...
                                <td className="p-3 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 text-yellow-500 text-sm">
                                            ...
                                            {/* Numeric rating */}
                                            <span className="text-gray-500">({item.rating.toFixed(1)})</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td className="p-3">
                                    {item.stock ? (
                                        ...
                                        <button className="bg-blue-900 hover:bg-blue-800 text-white px-4 py-1 rounded">
                                            Contact Us
                                        </button>
                                    )}
                                </td>
